...
namespace nts
{
    ...
    nts::Tristate	component4030::getState(std::tuple<IComponent *, std::size_t> comp1
						, std::tuple<IComponent *, std::size_t> comp2)
	{
        ...
        if (state1 == nts::Tristate::UNDEFINED || state2 == nts::Tristate::UNDEFINED)
			return (nts::Tristate::UNDEFINED);
		else if ((state1 == nts::Tristate::TRUE && state2 == nts::Tristate::FALSE) || 
